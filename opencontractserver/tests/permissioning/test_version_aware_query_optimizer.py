...
class TestVersionAwareAnnotationQueryOptimizer(TestCase):
    ...
    def test_default_queries_only_current_versions(self):
        ...
        self.assertEqual(result.count(), 0, "Should not return annotations for old version by default")
    ...
    def test_deleted_documents_are_excluded(self):
        ...
        self.assertEqual(result.count(), 0, "Deleted document should not return annotations")
        ...
        self.assertEqual(result.count(), 0, "Direct query should respect deletion status")
        ...
        self.assertEqual(result.count(), 1, "Can access deleted doc when check disabled")
    ...
    def test_structural_annotations_follow_document_versions(self):
        ...
        structural_v1 = Annotation.objects.create(
            document=doc_v1,
    ...
    def test_version_aware_performance(self):
        ...
        logger.info(f"✓ Version-aware query performance: {duration:.3f}s for {count} results")